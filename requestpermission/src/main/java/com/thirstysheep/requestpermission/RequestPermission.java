package com.thirstysheep.requestpermission;
...
//    private static RequestPermission mInstance;
    ...
    public static RequestPermission create(Context context) {
    ...
    public RequestPermission title(String title) {
        mTitle = title;
        return this;
    }

    public RequestPermission msg(String msg) {
        mMsg = msg;
        return this;
    }

    public RequestPermission permissions(List<PermissionItem> permissionItems) {
        mCheckPermissions = permissionItems;
        return this;
    }

    public RequestPermission filterColor(int color) {
        mFilterColor = color;
        return this;
    }

    public RequestPermission animStyle(int styleId) {
        mAnimStyleId = styleId;
        return this;
    }

    public RequestPermission style(int styleResIdsId) {
